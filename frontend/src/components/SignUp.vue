    ...
    <div class="form">
      ...
      <div class="container">
        ...
        <div class="description">
          Латинские буквы в нижнем регистре и цифры
          <div class="errors">{{ errors.loginError }}</div>
        </div>
      </div>
      <div class="container">
        <div class="input">
        ...
        <div class="description">
          example@mail.com
          <div class="errors">{{ errors.emailError }}</div>
        </div>
      </div>
      <div class="container">
        <div class="input">
        ...
        <div class="description">
          От 8 символов, разный регистр, одна цифра и спецсимвол
          <div class="errors">{{ errors.passwordError }}</div>
        </div>
      </div>
      <div class="container">
        <div class="input">
...
export default {
  ...
  methods: {
    ...mapActions(["fetchUsers", "register"]),
    isUserAlreadyExist() {
      let isExist = false;
